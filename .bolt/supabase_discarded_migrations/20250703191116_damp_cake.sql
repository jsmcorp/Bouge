/*
  ...
  3. Helper Function
    - Drop and recreate the is_group_member function to avoid parameter name conflicts
*/
...
-- Drop and recreate the private.is_group_member function to avoid parameter name conflicts
